...
class UploadService {
    ...
    downloadFile(key) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const file = yield this.s3.send(command);
            return file;
        });
    }
    ...
    createFolderOnS3(folderName, bucketType, userId, parentId) {
        return __awaiter(this, void 0, void 0, function* () {
            const bucketName = this.resolveBucket(bucketType);
            ...
            yield this.s3.send(command);
            const existingFolder = yield prisma_1.default.folder.findFirst({
                where: {
                    name: folderName,
                    userId,
