...
exports.validateFileUpload = [
    (0, express_validator_1.body)('folderId').optional().isString().withMessage('Folder ID must be a string'),
    (0, express_validator_1.body)('fileName').notEmpty().isString().withMessage('File name is required'),
    handleValidation,
];
exports.validateFileDownload = [
    (0, express_validator_1.param)('fileId').notEmpty().isString().withMessage('File ID is required'),
    handleValidation,
];
